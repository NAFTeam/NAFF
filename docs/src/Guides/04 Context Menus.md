...
For more information, please visit the API reference [here](/API Reference/models/Snek/application_commands/#naff.models.snek.application_commands.context_menu).
