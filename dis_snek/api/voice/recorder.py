...
from dis_snek.api.voice.audio import RawInputAudio
from dis_snek.api.voice.audio_writer import AudioWriter
from dis_snek.api.voice.encryption import Decryption
from dis_snek.api.voice.opus import Decoder
from dis_snek.client.const import logger_name
from dis_snek.client.utils.input_utils import unpack_helper
from dis_snek.models.discord.snowflake import Snowflake_Type, to_snowflake_list
