...
class BaseMessage(DiscordObject):
    channel_id: "Snowflake_Type" = Field(default=MISSING, converter=to_optional_snowflake)
    """the id of the channel the message was sent in"""
    thread_channel_id: Optional["Snowflake_Type"] = Field(default=None, converter=to_optional_snowflake)
    """the id of the thread the message was sent in, if any"""
    guild_id: Optional["Snowflake_Type"] = Field(default=None, converter=to_optional_snowflake)
    """the id of the guild the message was sent in, if any"""
    author_id: "Snowflake_Type" = Field(default=MISSING, converter=to_optional_snowflake)
    ...
    def channel(self) -> "models.TYPE_MESSAGEABLE_CHANNEL":
        ...
        channel = self._client.cache.get_channel(self.channel_id)

        if not self.guild_id and not channel:
            # allow dm operations without fetching a dm channel from API
            channel = BaseChannel.from_dict_factory({"id": self.channel_id, "type": ChannelTypes.DM}, self._client)
            if self.author:
    ...
    def thread(self) -> "models.TYPE_THREAD_CHANNEL":
        ...
        return self._client.cache.get_channel(self.thread_channel_id)
    ...
    def author(self) -> Union["models.Member", "models.User"]:
        ...
        if self.author_id:
            member = None
            if self.guild_id:
                member = self._client.cache.get_member(self.guild_id, self.author_id)
            return member or self._client.cache.get_user(self.author_id)
        return MISSING
...
class Message(BaseMessage):
    ...
    timestamp: "models.Timestamp" = Field(repr=False, default=MISSING, converter=optional_c(timestamp_converter))
    """When this message was sent"""
    edited_timestamp: Optional["models.Timestamp"] = Field(
        repr=False, default=None, converter=optional_c(timestamp_converter)
    )
    """When this message was edited (or `None` if never)"""
    tts: bool = Field(repr=False, default=False)
    """Whether this was a TTS message"""
    mention_everyone: bool = Field(repr=False, default=False)
    """Whether this message mentions everyone"""
    mention_channels: List[ChannelMention] = Field(repr=False, factory=list)
    """Channels specifically mentioned in this message"""
    attachments: List[Attachment] = Field(repr=False, factory=list)
    """Any attached files"""
    embeds: List["models.Embed"] = Field(repr=False, factory=list)
    """Any embedded content"""
    reactions: List["models.Reaction"] = Field(repr=False, factory=list)
    """Reactions to the message"""
    nonce: Optional[Union[int, str]] = Field(repr=False, default=None)
    """Used for validating a message was sent"""
    pinned: bool = Field(repr=False, default=False)
    """Whether this message is pinned"""
    webhook_id: Optional["Snowflake_Type"] = Field(repr=False, default=None, converter=to_optional_snowflake)
    """If the message is generated by a webhook, this is the webhook's id"""
    type: MessageTypes = Field(repr=False, default=MISSING, converter=optional_c(MessageTypes))
    """Type of message"""
    activity: Optional[MessageActivity] = Field(repr=False, default=None, converter=optional_c(MessageActivity))
    """Activity sent with Rich Presence-related chat embeds"""
    application: Optional["models.Application"] = Field(repr=False, default=None)  # TODO: partial application
    """Application sent with Rich Presence-related chat embeds"""
    application_id: Optional["Snowflake_Type"] = Field(repr=False, default=None, converter=to_optional_snowflake)
    ...
    flags: MessageFlags = Field(repr=False, default=MessageFlags.NONE, converter=MessageFlags)
    """Message flags combined as a bitfield"""
    interaction: Optional["MessageInteraction"] = Field(repr=False, default=None)
    """Sent if the message is a response to an Interaction"""
    components: Optional[List["models.ActionRow"]] = Field(repr=False, default=None)
    """Sent if the message contains components like buttons, action rows, or other interactive components"""
    sticker_items: Optional[List["models.StickerItem"]] = Field(repr=False, default=None)
    """Sent if the message contains stickers"""
    _mention_ids: List["Snowflake_Type"] = Field(repr=False, factory=list)
    _mention_roles: List["Snowflake_Type"] = Field(repr=False, factory=list)
    _referenced_message_id: Optional["Snowflake_Type"] = Field(repr=False, default=None)
    ...
    async def mention_users(self) -> AsyncGenerator["models.Member", None]:
        ...
        for u_id in self._mention_ids:
            yield await self._client.cache.fetch_member(self.guild_id, u_id)
    ...
    async def mention_roles(self) -> AsyncGenerator["models.Role", None]:
        ...
        for r_id in self._mention_roles:
            yield await self._client.cache.fetch_role(self.guild_id, r_id)
    ...
    async def fetch_referenced_message(self) -> Optional["Message"]:
        ...
        if self._referenced_message_id is None:
            return None
        return await self._client.cache.fetch_message(self.channel_id, self._referenced_message_id)
    ...
    def get_referenced_message(self) -> Optional["Message"]:
        ...
        if self._referenced_message_id is None:
            return None
        return self._client.cache.get_message(self.channel_id, self._referenced_message_id)
    ...
    def _process_dict(cls, data: dict, client: "Client") -> dict:
        ...
        if mentions_data := data.pop("mentions", None):
            ...
            data["_mention_ids"] = mention_ids

        found_ids = []
        mention_channels = []
        if "mention_channels" in data:
            for channel_data in data.pop("mention_channels"):
        ...
        if len(mention_channels) > 0:
            data["_mention_channels"] = mention_channels

        data["_mention_roles"] = data.pop("mention_roles", [])
    ...
    def proto_url(self) -> str:
        ...
        return f"discord://-/channels/{self.guild_id or '@me'}/{self.channel_id}/{self.id}"
    ...
    async def edit(
        ...
        *,
        ...
        if context:
            ...
            message_data = await self._client.http.edit_message(message_payload, self.channel_id, self.id, files=files)
            if message_data:
    ...
    async def suppress_embeds(self) -> "Message":
        ...
        message_data = await self._client.http.edit_message(
            {"flags": MessageFlags.SUPPRESS_EMBEDS}, self.channel_id, self.id
        )
        if message_data:
            return self._client.cache.place_message_data(message_data)
    ...
    async def fetch_reaction(
        ...
        reaction_data = await self._client.http.get_reactions(
            self.channel_id, self.id, emoji, limit, to_optional_snowflake(after)
        )
    ...
    async def remove_reaction(
        ...
        if user_id == self._client.user.id:
            await self._client.http.remove_self_reaction(self.channel_id, self.id, emoji_str)
        else:
            await self._client.http.remove_user_reaction(self.channel_id, self.id, emoji_str, user_id)
    ...
    async def clear_all_reactions(self) -> None:
        ...
        await self._client.http.clear_reactions(self.channel_id, self.id)
    ...
    async def publish(self) -> None:
        ...
        """
        await self._client.http.crosspost_message(self.channel_id, self.id)
